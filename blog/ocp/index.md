...
Thanks to the table inheritance, we don’t have to duplicate all the common fields that has been moved into the `Content` model.   Having said that, you can still see some repetitive thing need to be done for every new concrete type:
