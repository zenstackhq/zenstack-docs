---
description: How to build a collaborative SaaS product with secured access control using ZenStack
tags: [tutorial, nextjs, saas, zenstack]
authors: jiasheng
---

# How to build a collaborative SaaS product with secured access control using ZenStack
