...
ZenStack is built as an extension to the fantastic ORM toolkit - [Prisma](https://prisma.io). The goal is to unleash its full potential for full-stack web app development.
...
_NOTE_: This is the v1 prelease documentation. For the old v0.5 version, please visit [here](https://legacy.zenstack.dev).
