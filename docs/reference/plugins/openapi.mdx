...
| flavor          | String | API flavor: "rpc" or "rest". See [here](/docs/category/api-handlers) for more details.                                       | No       | rpc                   |
...
The two flavors correspond to the two style of APIs supported by ZenStack server adapters. See [here](/docs/category/api-handlers) for more details.
