...
-   getPrisma: `(request: Request, response: Response) => unknown | Promise<unknown>`
...
The APIs mounted by `ZenStackMiddleware` conforms to the OpenAPI V3 spec, and provides a path for each model and database operation combination, as listed [here](/docs/reference/plugins/openapi#generated-api-paths).
