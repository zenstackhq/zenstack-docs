...
```bash
npm install @zenstackhq/server @tanstack/react-query
...
[here](https://github.com/zenstackhq/docs-tutorial-nextjs-app-dir/tree/v1). For more details about ZenStack,
